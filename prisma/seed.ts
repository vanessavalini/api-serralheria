...
async function createMaterialProducts() {
  const materialProduct = await prisma.materialProduct.createMany({
    data: [
      { productId: 1, materialId: 5, formula: "2*L + 2*A" },
      { productId: 1, materialId: 6, formula: "L" },
      { productId: 1, materialId: 8, formula: "2*(A+L)" },
      { productId: 1, materialId: 16, formula: "(L-10mm)*(A-10mm)" },
      { productId: 1, materialId: 5, formula: "2*L + 2*A" },
      ...
      { productId: 2, materialId: 1, formula: "L" },
      { productId: 2, materialId: 2, formula: "L" },
      { productId: 2, materialId: 1, formula: "L" },
      { productId: 2, materialId: 3, formula: "2*A" },
      { productId: 2, materialId: 4, formula: "4*A + 4*(L/2)"},
      { productId: 2, materialId: 7, formula: "2*(A+L)" },
      { productId: 2, materialId: 15, formula: "(L/2 - 30mm)+(A - 40mm)" },
